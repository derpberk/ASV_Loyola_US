...
class Plan:
    ...
    def __init__(self, image, image_plantilla, mapa, mapa2, grid):
        """
            Args:
        ...
        self.planner=A_star(mapa,mapa2, 1)
...
def main():
    ...
    #read map
    mapp= Plan("Loyola.png","Loyolaplantilla.png","plantilla.csv", "plantilla2.csv", "grid.csv")
