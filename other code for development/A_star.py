...
if __name__ == '__main__':
    #try:
        ...
        for i in range(10000):
            while True:
                    start_pose_x = random.randint(0,x.width-1)
                    start_pose_y = random.randint(0,x.height-1)
                    if x.map[start_pose_y,start_pose_x] == 1:
                        pass
                    else:
                        break
            ...
            while True:
                    goal_pose_x = random.randint(0,x.width-1)
                    goal_pose_y = random.randint(0,x.height-1)
                    if x.map[goal_pose_y,goal_pose_x] == 1:
                        pass
                    else:
                        break
            x.compute_path([start_pose_y,start_pose_x,], [goal_pose_y,goal_pose_x])