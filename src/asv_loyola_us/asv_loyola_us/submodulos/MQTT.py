...
class MQTT(object):
    def __init__(self, name, addr='adress', port=1883, timeout=60, topics2suscribe=None, on_message=None, on_disconnect=None,user=None,password=None):
    ...
    def mqtt_thread(self, addr='adress', port=1883, timeout=60):
